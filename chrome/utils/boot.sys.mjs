...
import { loaderModuleLink, Pref, FileSystem, windowUtils, showNotification, startupFinished, restartApplication, escapeXUL } from "chrome://mods/content/utils.sys.mjs";
...
class UserChrome_js{
  ...
  onDOMContent(document){
    ...
    ChromeUtils.defineLazyGetter(window,"UC_API",() =>
      ChromeUtils.importESModule("chrome://mods/content/uc_api.sys.mjs")
    )
